namespace ImdbLite.Web.Areas.Administration.Controllers
{
    ...
    public class ArticlesController : AdminController
    {
        ...
        public ActionResult Update(int? id)
        {
            ...
            model.CelebritiesSelectList = this.populator.Celebrities.ToSelectList(x => x.Value, x => x.Key);
            model.MoviesSelectList = this.populator.Movies.ToSelectList(x => x.Value, x => x.Key);
        ...
        public ActionResult Create()
        {
            ...
            model.CelebritiesSelectList = this.populator.Celebrities.ToSelectList(x => x.Value, x => x.Key).ToList();
            model.MoviesSelectList = this.populator.Movies.ToSelectList(x => x.Value, x => x.Key);
